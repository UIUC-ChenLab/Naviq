...
TOPOLOGY = "src/noc/topology/topologies/cpu/smartnic_ddr_contention_separated_pkt100"
BINARY = (
    REPO_ROOT
    / "src"
    / "noc"
...
RUN_LABEL = "smartnic_ddr_contention_separated_pkt100"
...
print("[smartnic_ddr_contention_separated_pkt100] PASS")
