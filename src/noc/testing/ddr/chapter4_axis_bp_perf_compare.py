...
RUNS = [
    {
        "case": "none",
        "label": "smartnic_axis_bp_perf_none_pkt100",
        "script": THIS_DIR / "smartnic_axis_bp_perf_none_pkt100.py",
    },
    {
        "case": "moderate",
        "label": "smartnic_axis_bp_perf_moderate_pkt100",
        "script": THIS_DIR / "smartnic_axis_bp_perf_moderate_pkt100.py",
    },
    {
        "case": "strong",
        "label": "smartnic_axis_bp_perf_strong_pkt100",
        "script": THIS_DIR / "smartnic_axis_bp_perf_strong_pkt100.py",
    },
]
...
def _validate_comparison(row_by_label: dict) -> None:
    none = row_by_label["smartnic_axis_bp_perf_none_pkt100"]
    moderate = row_by_label["smartnic_axis_bp_perf_moderate_pkt100"]
    strong = row_by_label["smartnic_axis_bp_perf_strong_pkt100"]
