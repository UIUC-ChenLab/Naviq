...
# "Unaligned" here means the start address is not forced to the full transaction
# size. Starts must still be beat-aligned, and the sequence must never create a
# beat that crosses an NMU 256B boundary.
run_v2_smoke(
    label="HBM single port unaligned smoke",
