...
template <typename T>
struct wide_words32<const T> : wide_words32<T> {};

template <typename T>
struct wide_words32<volatile T> : wide_words32<T> {};

template <typename T>
struct wide_words32<const volatile T> : wide_words32<T> {};

template <typename T>
struct wide_words32<T&> : wide_words32<T> {};
